...
TREES_MODELS_BEST_PARAMETERS = {
    'DecisionTree': {'max_depth': 6, 'min_samples_leaf': 1, 'min_samples_split': 2, 'splitter': 'best'},
    'RandomForest': {'max_depth': 8, 'min_samples_leaf': 3, 'min_samples_split': 4, 'n_estimators': 10},
    'ExtraTree': {'max_depth': 10, 'min_samples_leaf': 3, 'min_samples_split': 3, 'n_estimators': 5}}
